            ...
            <>
              ...
              <aside className="event-details">
                ...
                <button
                  ...
                  onClick={async () => {
                    const fetchArtist = this.state.currentEvent._embedded
                      .attractions[0].name;
                    const artist = await findArtist(fetchArtist);
                    ...
                    if (artist.artist) {
                      ...
                      const newArtist = await addArtist({
                        name: this.props.currentEvent._embedded.attractions[0]
                          .name,
                        picture: this.props.currentEvent._embedded
                          .attractions[0].images[0].url
                      });
                    ...
                    if (event.event) {
                      ...
                      if (venue.venue) {
                        ...
                        const newVenue = await addVenue({
                          ...
                          picture:
                            currentEvent._embedded.venues[0].images[0].url
                        });
                        const newEvent = await addEvent(
                          {
                            title: currentEvent.name,
